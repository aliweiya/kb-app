...
Page({
    ...
    onLoad: function (option) {
        ...
        // id = '20161222A05EDW00';//相关组图和单图
        // id = '20161121A03GQ300';//多视频
        // _this.queryData.id = '20170102A01YDB00';
        var postData = {
            id: id,
            seq_no: _this.queryData.seq_no ? _this.queryData.seq_no : '',
            alg_version: _this.queryData.alg_version ? _this.queryData.alg_version : ''
        }
        article.getData(config.getUrl('article'), postData).then(function (data, state) {
            if (data.statusCode == 200 && data.data && data.data.ret == 0) {
                ...
                }).then(_this.renderRelateNews,_this.renderRelateNews);
